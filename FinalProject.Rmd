...
Since the data is quite large , I have filtered out only 8 cases which is required for my analysis. The important variables I have choosen for my analysis are "ST","VALP","LAPTOP","HISPEED","FULP","GASP","TYPE","FTAXP","TAXP","WIF","HINCP","GRNTP","RNTP","FINCP","RMSP","NP","ADJINC","ACR","FINCP","FHINCP","INSP".
...
# cols <- c("ST", "VALP")
# selectcols <- fread("/Users/sahilnagpal/Desktop/TrentU/Data-Analytics-R/Project/MainData.csv",select = cols)
...
<span style="color:blue">**Correlation Coefficient**</span>
